 ...
 *   <li>{@link courseManagement.impl.CourseSetImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseSetImpl extends MinimalEObjectImpl.Container implements CourseSet {
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CourseManagementPackage.COURSE_SET__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CourseManagementPackage.COURSE_SET__ELEMENTS:
			return getElements();
		case CourseManagementPackage.COURSE_SET__ID:
			return getId();
		}
